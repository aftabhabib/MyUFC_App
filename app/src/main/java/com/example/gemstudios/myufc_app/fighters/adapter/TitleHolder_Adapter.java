...
import com.example.gemstudios.myufc_app.fighters.Fighters_View_Activity;
...
public class TitleHolder_Adapter extends RecyclerView.Adapter<TitleHolder_Adapter.MyViewHolder> {

    private Context applicationContext;
    private int row;
    private List<TitleHolders> result;


    public TitleHolder_Adapter(Context applicationContext, List<TitleHolders> result, int row) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TitleHolder_Adapter.MyViewHolder((LayoutInflater.from(parent.getContext()).inflate(row, parent, false)));
    }
